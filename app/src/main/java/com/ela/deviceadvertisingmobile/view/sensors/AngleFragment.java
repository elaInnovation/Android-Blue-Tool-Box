...
public class AngleFragment extends Fragment
{
    ...
    {
        this.xData = v.findViewById(R.id.acc_x);
        this.yData = v.findViewById(R.id.acc_y);
        this.zData = v.findViewById(R.id.acc_z);
    ...
    private void updateUi(LinkedHashMap<String, Tag> tagList, LinkedHashMap<String, String> macList)
    {
        ...
        {
            if(entry.getValue() instanceof TagAngle) {
        ...
        try {
            ...
            for (Map.Entry<String, Tag> entry : tagList.entrySet()) {
                if (entry.getKey().equals(this.tagSelectedName) &&
                        (entry.getValue() instanceof TagAngle)) {
                    TagAngle tag = (TagAngle) entry.getValue();
                    this.tagName.setText(entry.getKey());
                    this.tagConnectName.setText(entry.getKey());
                    this.xData.setText(String.valueOf(tag.getxAng()).concat(" mg"));
                    this.yData.setText(String.valueOf(tag.getyAng()).concat(" mg"));
                    this.zData.setText(String.valueOf(tag.getzAng()).concat(" mg"));
                }
            }
        } catch (Exception e)
        {
